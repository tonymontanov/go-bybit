...
| `affiliate-user-list` | `affiliate.Client.{GetAffiliateUserList, GetFriendReferrals}` | yes (affiliate key for user list) |
| `premarket-instruments` | `premarket.Client.{GetPreLaunchInstruments, GetRiskLimit, GetTickers}` | no |
