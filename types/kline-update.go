...
DESCRIPTION:
KlineUpdate is one element of the Bybit V5 "kline.{interval}.{symbol}"
WebSocket topic — protocol-common across every category. Bybit pushes
a fresh kline on every interval boundary and updates the in-progress
kline at most once per second; the "Confirmed" flag distinguishes the
two cases.
