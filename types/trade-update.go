...
DESCRIPTION:
TradeUpdate is one element of the Bybit V5 "publicTrade.{symbol}"
WebSocket topic — protocol-common across every category. Bybit ships
trade frames in batches; the dispatcher fans them out so handlers
receive one TradeUpdate per call.
